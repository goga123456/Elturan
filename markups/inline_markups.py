...
def inc_category_kb() -> InlineKeyboardMarkup:
    ...
    b16 = InlineKeyboardButton('Написать вручную', callback_data='hand')
    b17 = InlineKeyboardButton('Назад', callback_data='back')
    category.add(b1).add(b2).add(b3, b4).add(b5, b6).add(b7, b8).add(b9, b10).add(b11, b12).add(b12, b13).add(b14, b15).add(b16).add(b17)
    return category
